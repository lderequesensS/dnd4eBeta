...
export class SaveThrowDialog extends DocumentSheet4e {
  ...
  getData() {
    ...
    return {
      ...
      effectName: options.effectSave
        ? this.object.effects.get(options.effectId).name
        : null,
      saveDC: options.effectSave
        ? this.object.effects.get(options.effectId).flags.dnd4e?.effectData
            ?.saveDC
        : null,
    };
  }
